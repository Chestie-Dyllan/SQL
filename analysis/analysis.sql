...
COPY table_name
FROM 'C:\Users\HP\SQL\analysis\your_file.csv'
...
FROM 'C:\Users\HP\SQL\analysis\us_counties_2010.csv'
WITH (FORMAT CSV, HEADER);

SELECT * FROM us_counties_2010;

ELECT geo_name, state_us_abbreviation, area_land
...
FROM 'C:\Users\HP\SQL\analysis\supervisor_salaries.csv'
WITH (FORMAT CSV, HEADER);
...
COPY supervisor_salaries_temp (town, supervisor, salary) FROM 'C:\Users\HP\SQL\analysis\supervisor_salaries.csv' WITH (FORMAT CSV, HEADER);
...
COPY us_counties_2010
TO 'C:\Users\HP\SQL\analysis\us_counties_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');

COPY us_counties_2010 (geo_name, internal_point_lat, internal_point_lon)
TO 'C:\Users\HP\SQL\analysis\us_counties_latlon_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');
...
COPY us_counties_2000 FROM 'C:\Users\HP\SQL\analysis\us_counties_2000.csv' WITH (FORMAT CSV, HEADER);
...
COPY new_york_addresses FROM 'C:\Users\HP\SQL\analysis\city_of_new_york.csv' WITH (FORMAT CSV, HEADER);
...
COPY pls_fy2014_pupld14a FROM 'C:\Users\HP\SQL\analysis\pls_fy2014_pupld14a.csv' WITH (FORMAT CSV, HEADER);
...
COPY pls_fy2009_pupld09a FROM 'C:\Users\HP\SQL\analysis\pls_fy2009_pupld09a.csv' WITH (FORMAT CSV, HEADER);
...
SELECT pls14.stabr,
       ...
       sum(pls09.visits) AS visits_2009,
	   sum(pls14.visit) - sum(pls09.visit)
